...
eb.removeUsersFromProjects = async function removeUsersFromProjects({
  ...
  try {
    const projectSelector = await page.waitForSelector("#ctl00_ctl00_ContentPlaceHolder1_contentSection_lbxSelectedProjects");
    console.log(projectSelector.toString());
  } catch (error) {
